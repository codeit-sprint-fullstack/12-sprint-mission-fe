...
CRUD를 다시 한번 연습할 수 있었고 쿼리 파라미터의 사용법을 알 수 있어서 좋았다 try랑 catch는 사실 실습할때 자주 사용안해가지고 이번 기회에 많이 써봐서 연습이 된 것 같다. 강제로 에러를 일으키는 방법을 몰라서 ai한테 물어봤는데 다음에는 검색으로 찾아봐야지..
