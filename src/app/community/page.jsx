...
const CommunityPage = () => {
  return (
    <div className="flex flex-col items-center my-[24px]">
      <main className="flex flex-col mx-[16px] md:mx-[24px] lg:w-[1200px] gap-[40px]">
        <section className="flex flex-col gap-[24px]">
          <h2 className="text-xl font-bold text-(--Secondary-900)">
            베스트 게시글
          </h2>
          <div className="flex gap-[24px]">
            <div className="relative w-full px-[24px] pt-[46px] pb-[16px] rounded-lg bg-(--Secondary-100) flex flex-col justify-center md:max-w-[340px] lg:max-w-[384px]">
              <Image
                src={imgBadge}
                alt="베스트 뱃지"
                width={102}
              ...
              />
              <div className="flex flex-col gap-[40px] lg:gap-[18px]">
                <div className="flex gap-[40px] lg:gap-2">
                  <p className="font-semibold text-2lg text-(--Secondary-800) lg:text-xl">
